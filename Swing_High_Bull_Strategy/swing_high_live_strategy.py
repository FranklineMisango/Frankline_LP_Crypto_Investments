...
class SwingHigh():
    ...
    def __init__(self):
        ...
        self.datashares_per_ticker = {}  # Dictionary to specify the number of trades per cryptocurrency
        self.positions = {}  # Dictionary to track positions

    def fetch_the_volatile_cryptocurrencies(self, hours=24):
        now = dt.now()
        ...
        #save the volatile_tickers in a csv file
